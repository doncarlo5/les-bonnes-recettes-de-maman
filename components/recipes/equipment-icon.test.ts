...
describe("resolveEquipmentIcon", () => {
  it.each([
    ...
    ["1 petit bol", "bowl"],
    ["1 small bowl", "bowl"],
    ["1 moule à cake", "loaf-pan"],
    ["1 loaf pan", "loaf-pan"],
    ["1 moule à cake ou 12 moules à mini-cakes", "loaf-pan"],
    ["1 loaf pan or 12 mini-loaf molds", "loaf-pan"],
    ["5 empreintes à muffins", "muffin-pan"],
    ["5 muffin cups", "muffin-pan"],
    ["1 plaque de cuisson", "baking-sheet"],
